 ...
 * Adapter between Eloquent user (implements Authenticatable) and LanguageDetector\Domain\Language\Contracts\UserInterface
 ...
 */
use LanguageDetector\Domain\Language\Contracts\UserInterface as CoreUserInterface;
